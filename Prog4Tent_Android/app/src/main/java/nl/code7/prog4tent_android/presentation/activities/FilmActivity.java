...
import nl.code7.prog4tent_android.adapter.DrawerItemCustomAdapter;
...
public class FilmActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DrawerItemCustomAdapter adapter = new DrawerItemCustomAdapter(this, R.layout.listview_sidebar_item_row, drawerItem);
